...
import { changeLock } from "@/store/slices/tier-list";
...
const TierListLock: React.FC = () => {
    ...
    return localStorage.getItem("isLockAlertNotFirstTime") ? (
        ...
        <AlertDialog
            title="Locking a tier list"
            description="When locking a tier list no one can edit that tier list other than you (if you have an account) if not when saving you will lose the ability to edit the tier list as well"
            button={btn}
